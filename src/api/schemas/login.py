...
class ChangePasswordUserSchema(BaseModel):
    ...
    recent_password: str = Field(min_length=8, max_length=50, exclude=True, examples=["P@ssw0rd!"])
    new_password: str = Field(min_length=8, max_length=50)
    confirm_new_password: str = Field(min_length=8, max_length=50, exclude=True, examples=["P@ssw0rd!"])
    ...
    def passwords_match(cls, model: 'ChangePasswordUserSchema') -> 'ChangePasswordUserSchema':
